    ...
    <div
      ...
      className={`bg-white rounded-xl border border-gray-200 p-6 transition-all duration-200 group min-h-[240px] ${
        project.is_small_project
          ? 'cursor-default'
          : 'hover:shadow-lg hover:border-[#F4B223] hover:border-brp-primary cursor-pointer hover:h-auto'
      }`}
    >
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <h3 className={`text-lg font-semibold text-gray-900 mb-2 transition-colors ${
            !project.is_small_project && 'group-hover:text-[#F4B223] group-hover:text-brp-primary'
          }`}>
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={handleEdit}
            className="p-2 text-[#F4B223] text-brp-primary hover:text-[#D69620] hover:text-brp-primaryHover hover:bg-[rgba(244,178,35,0.15)] hover:bg-brp-primarySoft rounded-lg transition-colors opacity-0 group-hover:opacity-100"
            title="Edit Project"
          >
          ...
          <ArrowRight className="w-5 h-5 text-gray-400 group-hover:text-[#F4B223] group-hover:text-brp-primary group-hover:translate-x-1 transition-all duration-200" />
        </div>
      </div>
