      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center space-x-3">
              ...
              <>
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-20">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 text-left hover:bg-gray-100 flex items-center space-x-2 transition-colors"
                  >
                    <FileText className="w-5 h-5 text-[#F4B223]" />
          ...
          <button
            ...
            className="bg-[#F4B223] hover:bg-[#E5A520] text-white px-4 py-2 rounded-lg font-medium flex items-center space-x-2 transition-colors"
          >
      ...
      {filteredProjects.length === 0 ? (
        <div className="text-center py-12">
          ...
          {!searchTerm && (
            <button
              onClick={() => setShowCreateModal(true)}
              className="bg-[#F4B223] hover:bg-[#E5A520] text-white px-6 py-3 rounded-lg font-medium inline-flex items-center space-x-2 transition-colors"
            >
              <Plus className="w-5 h-5" />
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#F4B223] focus:border-transparent"
                >
              ...
              <button
                ...
                className="w-full bg-[#F4B223] hover:bg-[#E5A520] text-white px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
